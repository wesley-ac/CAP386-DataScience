...
#### 1.4) Run some examples that show that the recycling rule reuses the smaller (shorter) vector.
...
#### 1.5) What does stringsAsFactors=FALSE in read.csv() do? Why do we need it? (see Lecture02/06-DataFrames).
